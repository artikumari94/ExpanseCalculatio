...
import com.expense.calculation.adapter.DrawerListViewAdapter;
import com.expense.calculation.adapter.HomeViewPagerAdapter;
import com.expense.calculation.notification.FillExpenseNotificationScheduler;
import com.expense.calculation.presenter.NavigationDrawerPresenter;
...
public class MainActivity extends FragmentActivity implements NavigationDrawerItemView, ActionBar.TabListener {
  ...
  public void onBackPressed() {
    ...
    actionBar.setBackgroundDrawable(getResources().getDrawable(R.drawable.button_primary));
  }
